...
from exec_wrappers.create_wrappers import (
...
WRAPPER_TYPE_ARGS_CONTENT = [
    ...
    (
        "virtualenv",
        (["--virtual-env-dir", "virtualenv/test-env"]),
...
@pytest.mark.parametrize(
    ("wrapper_type", "extra_args", "contents"), WRAPPER_TYPE_ARGS_CONTENT
)
...
@pytest.mark.skipif(
    sys.platform != "win32", reason="Extension handling only on Windows"
)
